...
var fightOrSkip = function() {
    ...
    // Conditional recursive function call - makes the function repeat/loop
    ...
    if (promptFight === "skip") {
        ...
        if (confirmSkip) {
            ...
            playerInfo.money = Math.mac(0, playerInfo.money - 10);
...
var fight = function(enemy) {
    ...
    while(playerInfo.health > 0 && enemy.health > 0) {
       ...
       if (promptFight === "skip" || promptFight === "SKIP") {
        ...
        console.log(
            enemyNames + ' attacked ' + playerInfo.name + '. ' + playerInfo.name + ' now has ' + playerInfo.health + ' health remaining.'
        );
